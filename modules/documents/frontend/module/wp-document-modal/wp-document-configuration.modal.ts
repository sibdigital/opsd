...
@Component({
  templateUrl: './wp-document-configuration.modal.html'
})
export class WpDocumentConfigurationModalComponent extends OpModalComponent implements OnInit, OnDestroy {
