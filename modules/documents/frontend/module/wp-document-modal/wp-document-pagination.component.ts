...
import {WpDocumentConfigurationModalComponent} from "./wp-document-configuration.modal";

@Component({
  templateUrl: 'wp-document-pagination.component.html',
  selector: 'wp-document-pagination'
})
export class WorkPackageDocumentPaginationComponent implements OnInit, OnDestroy {
  ...
  constructor(protected wpDocumentConfigurationModalComponent: WpDocumentConfigurationModalComponent,
              readonly I18n: I18nService) {
  }

  ngOnInit() {
    this.wpDocumentConfigurationModalComponent
  ...
  public showPage(pageNumber: number) {
    this.wpDocumentConfigurationModalComponent.updateFromObject({page: pageNumber});
  }
}
