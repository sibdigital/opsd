...
class Widget2::Table < Widget2::Base
  extend Report2::InheritedAttribute
  ...
  def initialize(query)
    raise ArgumentError, 'Tables only work on Reports2!' unless (query.kind_of? Report2) #|| (query.is_a? TargetQuery)
    super
  end
  ...
  fancy_table Widget2::Table::ReportTable
