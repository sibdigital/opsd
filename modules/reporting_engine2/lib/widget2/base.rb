...
require_dependency 'reporting_widget2'
module ::Widget2
  class Base < ::ReportingWidget2
    attr_reader :engine, :output
    attr_accessor :request

    ##
    # Deactivate caching for certain widgets. If called on Widget2::Base,
    ...
    def self.dont_cache?
      @dont_cache or self != Widget2::Base && Widget2::Base.dont_cache?
    end
