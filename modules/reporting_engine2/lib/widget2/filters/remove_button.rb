...
# make sure to require Widget2::Filters::Base first because otherwise
# ruby might find Base within Widget and Rails will not load it
require_dependency 'widget2/filters/base'
class Widget2::Filters::RemoveButton < Widget2::Filters::Base
  def render
