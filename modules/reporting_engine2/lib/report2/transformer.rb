...
class Report2::Transformer
  ...
  ##
  # @return [Report2::Result::Base] Result tree with row group bys at the top
  ...
  ##
  # @return [Report2::Result::Base] Result tree with column group bys at the top
