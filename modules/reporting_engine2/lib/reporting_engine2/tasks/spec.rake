...
begin
  ...
  namespace :spec do
    namespace :plugins do
      ...
      Spec::Rake::SpecTask.new(:reporting_engine2) do |t|
        t.spec_opts = ['--options', "\"#{Rails.root}/spec/spec.opts\""]
        t.spec_files = FileList['vendor/plugins/reporting_engine2/spec/**/*_spec.rb']
      end
      ...
      Spec::Rake::SpecTask.new(:"reporting_engine:rcov") do |t|
        ...
        t.spec_files = FileList['vendor/plugins/reporting_engine2/spec/**/*_spec.rb']
        t.rcov = true
        t.rcov_opts = ['-x', "\.rb,spec", '-i', 'reporting_engine2/app/,redmine_reporting/lib/']
      end
    end
  end
