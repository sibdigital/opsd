...
TypedDag::Configuration.set node_class_name: 'WorkPackage',
                            ...
                            types: {
                              ...
                              follows: { from: :precedes,
                                         ...
                                         all_to: :all_follows },
                              #bbm(
                              commonstart: { from: :commonstarted_with,
                                             to: :commonstart_with,
                                             all_from: :all_commonstarted_with,
                                             all_to: :all_commonstart_with },
                              commonfinish: { from: :commonfinished_with,
                                             to: :commonfinish_with,
                                             all_from: :all_commonfinished_with,
                                             all_to: :all_commonfinish_with },
                              # )
