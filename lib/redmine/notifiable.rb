...
module Redmine
  class Notifiable < Struct.new(:name, :parent)
    ...
    def self.all
      ...
      notifications << Notifiable.new('news_changed') #ban
      notifications << Notifiable.new('news_deleted') #ban
      ...
      notifications << Notifiable.new('work_package_report_notify_assignee')
