 ...
 * Keyboard events
 */
const isArrowUp = function (keyCode:any) {
  return keyCode === 38;
};
const isArrowDown = function (keyCode:any) {
  return keyCode === 40;
};
const isArrowUpDown = function (keyCode:any) {
  return isArrowUp(keyCode) || isArrowDown(keyCode);
};
const isEnter = function (keyCode:any) {
  return keyCode === 13;
};
const isBackspace = function (keyCode:any) {
  return keyCode === 8;
};
const isDelete = function (keyCode:any) {
  return keyCode === 46;
};
const isESC = function (keyCode:any) {
  return keyCode === 27;
};
const isTab = function (keyCode:any) {
  return keyCode === 9;
};
...
export class AutocompleteComponent implements OnInit, OnChanges, ControlValueAccessor {
   ...
   * @param selected
   */
  saveHistory(selected:never) {//cant use type any, so use never instead
