...
export class PlanStagePackageQuerySelectDropdownComponent implements OnInit, OnDestroy {
  ...
  constructor(readonly ref:ChangeDetectorRef,
              ...
              readonly pspStaticQueries:PlanStagePackageStaticQueriesService,
  ...
  private transformQueries(collection:CollectionResource<QueryResource>) {
    ...
    const combinedQueries = loadedQueries.concat(this.pspStaticQueries.all);
...
DynamicBootstrapper.register({selector: 'psp-query-select', cls: PlanStagePackageQuerySelectDropdownComponent});
