...
export const selectableTitleIdentifier = 'psp-query-selectable-title';

@Component({
  selector: 'psp-query-selectable-title',
  templateUrl: './psp-query-selectable-title.html',
  styleUrls: ['./psp-query-selectable-title.sass'],
  // Don't encapsulate styles because we're styling within other components
  encapsulation: ViewEncapsulation.None,
  host: { 'class': 'title-container' }
})
export class PlanStagePackageQuerySelectableTitleComponent implements OnInit {
