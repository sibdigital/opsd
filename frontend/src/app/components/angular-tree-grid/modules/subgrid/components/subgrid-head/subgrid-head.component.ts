...
export class SubgridHeadComponent implements OnInit {
  ...
  sortColumn(row_data:any, column:any) {
    ...
    column.sort_type ? row_data.children.sort((a:any, b:any) => (a[sort_by] > b[sort_by]) ? 1 : ((b[sort_by] > a[sort_by]) ? -1 : 0)) :
      row_data.children.sort((a:any, b:any) => (a[sort_by] < b[sort_by]) ? 1 : ((b[sort_by] < a[sort_by]) ? -1 : 0));
  }
