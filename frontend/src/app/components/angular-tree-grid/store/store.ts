...
export class Store {
    ...
    filterBy(columns:any, search_values:any) {
    ...
    findTopParentNode(data:any, configs:any) {
        const ids = data.map((element:any) => element[configs.id_field]);
        let top_parents:any = [];
    ...
    processData(data:any, expand_tracker:any, configs:Configs, edit_tracker:any, internal_configs:any) {
    ...
    orderData(data:any, processed_data:any, configs:any, parents:any, paths:any, levelx:any) {
