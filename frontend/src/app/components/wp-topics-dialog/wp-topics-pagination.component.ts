...
@Component({
  templateUrl: 'wp-topics-pagination.component.html',
  selector: 'wp-topics-pagination'
})
export class WorkPackageTopicsPaginationComponent implements OnInit, OnDestroy {
  ...
  constructor(protected wpTopicsConfigurationModalComponent:WpTopicsConfigurationModalComponent,
              readonly I18n:I18nService) {
  }

  ngOnInit() {
    this.wpTopicsConfigurationModalComponent
  ...
  public showPage(pageNumber:number) {
    this.wpTopicsConfigurationModalComponent.updateFromObject({page: pageNumber});
  }
}
