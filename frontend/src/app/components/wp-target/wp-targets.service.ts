...
import {TargetsDmService} from "core-app/modules/hal/dm-services/targets-dm.service";


@Injectable()
export class WorkPackageTargetsService {

  /!*@ngInject*!/
  constructor(private targetsDm:TargetsDmService,
