...
export class JavaApiPaths {
  ...
  public readonly nationalProjects = new SimpleResourceCollection(this.javaApiBasePath, 'nationalProjects');

  public readonly enumerations = new SimpleResourceCollection(this.javaApiBasePath, 'enumerations');
