class CreateMethodReestrCommunAndZs < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    create_table :stakeholders do |t|
      ...
      t.string  :type #тип для разделения на типовые и проектный ЗС: TypedStakeholder ProjectStakeholder

      t.timestamps
    end

    # Для контактной информации заинтересованных сторон
