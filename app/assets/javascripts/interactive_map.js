...
function setMilestones()
{
  ...
  jQuery.ajax({
      type: 'GET',
      url: '/interactive_map/get_dues',
      data: {project_id: jQuery(document).find('#choose_project_for_map')[0].value},
      async: true,
...
var colorsByDue=function(){
  jQuery('button.button-milestones').click(function()
  {
    setMilestones();
  });
};
...
jQuery(document).ready(colorsByDue());
